...
namespace penCsharpener.ImapData {
    public static class AESThenHMAC {
        ...
        public static string Encrypt(this string s, string password) {
            return Convert.ToBase64String(SimpleEncryptWithPassword(Encoding.UTF8.GetBytes(s), password));
        }

        public static string Decrypt(this string s, string password) {
            return Encoding.UTF8.GetString(SimpleDecryptWithPassword(Convert.FromBase64String(s), password));
        }
